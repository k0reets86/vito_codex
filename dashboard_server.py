            ...
            def do_GET(self):
                ...
                if parsed.path == "/api/config":
                    allowed = [
                        ...
                        "OPERATION_MAX_USD",
                        "AUTONOMY_MAX_MODE",
                        "AUTONOMY_REQUIRE_PUBLISH_APPROVAL",
                        "AUTONOMY_ECOMMERCE_APPROVAL_REQUIRED",
                        "AUTONOMY_DISABLE_PUBLISH_COOLDOWNS",
                        "AUTONOMY_DISABLE_PUBLISH_DUPLICATE_BLOCK",
                        "AUTONOMY_ALLOW_EXISTING_PRODUCT_UPDATE",
                        "AUTONOMY_ACCEPT_INTERMEDIATE_PUBLISH_STATUSES",
                        "OWNER_INBOX_ENABLED",
                        "CALENDAR_UPDATE_LLM",
                        "LLM_DISABLED_MODELS",
                        "LLM_ENABLED_MODELS",
