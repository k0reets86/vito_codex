...
_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "trend_scout": {
        ...
        "workflow_roles": {"lead": ["trend_pipeline"], "support": ["research_pipeline", "marketing_pipeline", "growth_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "content_creator": {
        ...
        "runtime_enforced": True,
        "tool_scopes": ["llm_router", "file_generation", "template_assets", "content_runtime_profile", "listing_optimizer"],
        ...
        "workflow_roles": {"lead": ["content_pipeline"], "support": ["publish_pipeline", "launch_pipeline", "growth_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "smm_agent": {
    ...
    "marketing_agent": {
        ...
        "runtime_enforced": True,
        "tool_scopes": ["llm_router", "analytics_inputs", "research_inputs", "budget_profiles", "channel_mix_rules", "growth_runtime_profile"],
        ...
        "memory_outputs": ["offer_playbooks", "positioning_lessons", "channel_mix_patterns", "budget_fit_rules", "strategy_recovery_notes"],
        "escalation_rules": ["escalate_on_unclear_audience", "escalate_on_no_budget_fit", "escalate_on_strategy_conflict"],
        "workflow_roles": {"lead": ["marketing_pipeline"], "support": ["publish_pipeline", "growth_pipeline", "launch_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "ecommerce_agent": {
    ...
    "email_agent": {
        ...
        "runtime_enforced": True,
        "tool_scopes": ["gmail", "newsletter_tools", "templates", "send_checklists", "email_runtime_profile"],
        ...
        "memory_outputs": ["email_templates", "engagement_lessons", "sequence_patterns", "deliverability_notes", "email_recovery_patterns"],
        "escalation_rules": ["escalate_on_missing_audience", "escalate_on_send_blocker", "escalate_on_sequence_gap"],
        "workflow_roles": {"lead": ["email_pipeline"], "support": ["launch_pipeline", "retention_pipeline", "growth_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "translation_agent": {
    ...
    "analytics_agent": {
        ...
        "collaborates_with": ["marketing_agent", "economics_agent", "smm_agent", "hr_agent", "quality_judge", "vito_core"],
        "memory_inputs": ["performance_baselines", "campaign_results", "forecast_lessons", "anomaly_signatures"],
        "memory_outputs": ["performance_baselines", "forecast_lessons", "anomaly_signatures", "optimization_recommendations"],
        "escalation_rules": ["escalate_on_anomaly_cluster", "escalate_on_negative_margin_pattern", "escalate_on_low_confidence_forecast"],
        "workflow_roles": {"lead": ["analytics_pipeline"], "support": ["optimization_pipeline"], "verify": ["quality_judge"]},
    },
    "economics_agent": {
        "role": "pricing_helper",
        "primary_kind": "helper",
    ...
    "devops_agent": {
        ...
        "tool_scopes": ["shell", "health_checks", "backup_tools", "runtime_remediation", "ops_runtime_profile"],
        "collaborates_with": ["security_agent", "hr_agent", "vito_core", "self_healer", "quality_judge"],
        "memory_inputs": ["ops_runbooks", "incident_lessons", "failure_memory", "tooling_governance"],
        "memory_outputs": ["ops_runbooks", "incident_lessons", "repair_journal", "runtime_fix_history"],
        "escalation_rules": ["escalate_on_repeat_failure", "escalate_on_unsafe_command", "escalate_on_backup_gap"],
        "workflow_roles": {"lead": ["runtime_maintenance_pipeline"], "support": ["self_healing_pipeline"], "verify": ["quality_judge"]},
    },
    "hr_agent": {
    ...
    "partnership_agent": {
        ...
        "tool_scopes": ["research", "crm_notes", "outreach_templates", "partner_scoring_rules", "growth_runtime_profile"],
        "collaborates_with": ["marketing_agent", "email_agent", "research_agent", "quality_judge", "analytics_agent"],
        "memory_inputs": ["partner_playbooks", "partner_fit_scores", "outreach_learning", "owner_preferences"],
        "memory_outputs": ["partner_playbooks", "partner_fit_scores", "outreach_learning", "deal_outcomes"],
        "escalation_rules": ["escalate_on_low_fit_pool", "escalate_on_missing_partner_data", "escalate_on_outreach_blocker"],
        "workflow_roles": {"lead": ["partnership_pipeline"], "support": ["growth_pipeline"], "verify": ["quality_judge"]},
    },
    "research_agent": {
        ...
        "memory_outputs": ["research_findings", "source_quality_lessons", "research_gap_signatures", "research_recovery_patterns", "source_mix_notes"],
        "escalation_rules": ["escalate_on_gap_count", "escalate_on_weak_source_mix", "escalate_on_judge_reject"],
        "workflow_roles": {"lead": ["research_pipeline"], "support": ["strategy_pipeline", "trend_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "document_agent": {
        ...
        "memory_outputs": ["knowledge_blocks", "document_lessons", "document_recovery_patterns", "extract_quality_notes", "source_integrity_notes"],
        "escalation_rules": ["escalate_on_unsupported_format", "escalate_on_missing_source_file", "escalate_on_ocr_unavailable"],
        "workflow_roles": {"lead": ["knowledge_ingest_pipeline"], "support": ["research_pipeline", "agent_improvement_pipeline"], "verify": ["quality_judge", "vito_core"]},
    },
    "account_manager": {
