...
_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "trend_scout": {
        ...
        "tool_scopes": ["browser_read", "search", "feeds"],
        "collaborates_with": ["research_agent", "seo_agent", "marketing_agent"],
        "memory_outputs": ["market_signals", "trend_lessons"],
    ...
    "translation_agent": {
        ...
        "tool_scopes": ["llm_router"],
        "collaborates_with": ["content_creator", "smm_agent", "publisher_agent"],
        "memory_outputs": ["localization_lessons"],
    ...
    "analytics_agent": {
        ...
        "tool_scopes": ["analytics_sources", "dashboard", "forecasting"],
        "collaborates_with": ["marketing_agent", "economics_agent", "smm_agent", "hr_agent"],
        "memory_outputs": ["performance_baselines", "forecast_lessons"],
    ...
    "economics_agent": {
        ...
        "tool_scopes": ["pricing_models", "analytics_inputs"],
        "collaborates_with": ["analytics_agent", "marketing_agent", "ecommerce_agent"],
        "memory_outputs": ["pricing_rules"],
    ...
    "legal_agent": {
        ...
        "tool_scopes": ["llm_router", "policy_docs"],
        "collaborates_with": ["risk_agent", "security_agent", "publisher_agent"],
        "memory_outputs": ["policy_constraints", "legal_lessons"],
    ...
    "research_agent": {
        ...
        "tool_scopes": ["browser_read", "search", "url_context", "research_cache"],
        "collaborates_with": ["trend_scout", "seo_agent", "marketing_agent", "document_agent"],
        "memory_outputs": ["research_findings", "source_quality_lessons"],
    ...
    "document_agent": {
        ...
        "tool_scopes": ["document_parsers", "ocr", "video_extract"],
        "collaborates_with": ["research_agent", "vito_core", "hr_agent"],
        "memory_outputs": ["knowledge_blocks", "document_lessons"],
