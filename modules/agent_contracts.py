...
_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "trend_scout": {
        ...
        "collaborates_with": ["research_agent", "seo_agent", "marketing_agent", "analytics_agent", "quality_judge"],
        ...
        "workflow_roles": {"lead": ["trend_pipeline"], "support": ["research_pipeline", "marketing_pipeline"], "verify": ["quality_judge"]},
    },
    "content_creator": {
        ...
        "collaborates_with": ["seo_agent", "quality_judge", "marketing_agent", "smm_agent", "ecommerce_agent", "publisher_agent"],
        ...
        "workflow_roles": {"lead": ["content_pipeline"], "support": ["publish_pipeline", "launch_pipeline"], "verify": ["quality_judge"]},
    },
    "smm_agent": {
    ...
    "marketing_agent": {
        ...
        "collaborates_with": ["trend_scout", "research_agent", "smm_agent", "seo_agent", "analytics_agent", "quality_judge"],
        "memory_inputs": ["owner_memory", "skill_memory", "anti_pattern_memory", "offer_playbooks", "positioning_lessons"],
        "memory_outputs": ["offer_playbooks", "positioning_lessons", "channel_mix_patterns"],
        "escalation_rules": ["escalate_on_unclear_audience", "escalate_on_no_budget_fit", "escalate_on_strategy_conflict"],
        "workflow_roles": {"lead": ["marketing_pipeline"], "support": ["publish_pipeline", "growth_pipeline"], "verify": ["quality_judge"]},
    },
    "ecommerce_agent": {
    ...
    "email_agent": {
        ...
        "collaborates_with": ["content_creator", "marketing_agent", "account_manager", "analytics_agent", "quality_judge"],
        "memory_inputs": ["owner_memory", "skill_memory", "anti_pattern_memory", "email_templates", "sequence_patterns"],
        "memory_outputs": ["email_templates", "engagement_lessons", "sequence_patterns"],
        "escalation_rules": ["escalate_on_missing_audience", "escalate_on_send_blocker", "escalate_on_sequence_gap"],
        "workflow_roles": {"lead": ["email_pipeline"], "support": ["launch_pipeline", "retention_pipeline"], "verify": ["quality_judge"]},
    },
    "translation_agent": {
    ...
    "research_agent": {
        ...
        "collaborates_with": ["trend_scout", "seo_agent", "marketing_agent", "document_agent", "analytics_agent", "quality_judge"],
    ...
    "document_agent": {
        ...
        "collaborates_with": ["research_agent", "vito_core", "hr_agent", "quality_judge"],
        ...
        "workflow_roles": {"lead": ["knowledge_ingest_pipeline"], "support": ["research_pipeline"], "verify": ["quality_judge"]},
    },
    "account_manager": {
