...
Цель: превратить слабых агентов в реальные operational units.
...
Цель: добить рабочих, но нестабильных агентов.
...
- weak agents перестали быть thin-wrapper;
- 8 ключевых workflow проходят;
