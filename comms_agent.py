...
class CommsAgent:
    ...
    def _strip_technical_paths(self, text: str) -> str:
        return self._notification_router.strip_technical_paths(text)
    ...
    def _inline_file_paths(self, text: str) -> str:
        return self._notification_router.inline_file_paths(text)
    ...
    async def send_message(self, text: str, level: str = "info") -> bool:
        return await self._notification_router.send_message(text, level=level)

    async def send_file(self, file_path: str, caption: str = "") -> bool:
        return await self._notification_router.send_file(file_path, caption=caption)
